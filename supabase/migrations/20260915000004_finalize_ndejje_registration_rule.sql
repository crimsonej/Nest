-- Finalize the deployed Ndejje registration rule for existing databases.

update public.universities
set accepted_reg_number_pattern = '^[0-9]{2}/[12]/[0-9]{3}/[A-Za-z]/[0-9]+$',
    example_reg_number = coalesce(example_reg_number, '26/2/222/D/2222')
