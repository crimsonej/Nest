...
import { LayoutDashboard, Users, BookOpen, Settings, LogOut, Menu, X, User, ListChecks } from 'lucide-react'
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-20 items-center justify-between border-b border-white/10 px-6">
        <Link href="/student/dashboard" onClick={onClose} className="flex items-center gap-3 text-white">
          ...
          <div>
            ...
            <small className="block text-[10px] font-bold uppercase tracking-[0.14em] opacity-75">Student Portal</small>
          </div>
        </Link>
        {isMobile && (
          <button
